    ...
    await resend.emails.send({
      ...
      html: `
        <div style="background:#050505;color:#fff;font-family:Arial,sans-serif;padding:40px;max-width:560px;">
          ...
          <a href="https://launchatdawn.com/contact/hello" style="display:inline-block;margin-top:12px;background:#F95D0A;color:#000;padding:14px 32px;border-radius:999px;text-decoration:none;font-weight:800;text-transform:uppercase;font-size:12px;letter-spacing:1px;">Book a Growth Call</a>
